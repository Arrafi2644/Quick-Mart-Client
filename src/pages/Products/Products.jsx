...
import { IoMdArrowDroprightCircle, IoMdCloseCircleOutline } from "react-icons/io";
...
const Products = () => {
    ...
    return (
        <div className='my-8 font-medium'>
            ...
            <div className='grid grid-cols-1 gap-4 lg:grid-cols-4 xl:grid-cols-5 relative overflow-hidden'>

                {/* sidebar  */}
                <div className={`hidden lg:block border p-2 font-medium rounded-md border-gray-300`}>
                ...
                <div className={`absolute max-w-80 ${showSideMenu ? "right-0 top-0" : "-right-80 -top-0"} bg-gray-100 z-50 border p-2 font-medium rounded-md border-gray-300 transition-all duration-200`}>
                    <div className='flex justify-between gap-2'>
                        <h2 className='font-semibold text-lg'>Filters</h2>
                        <button
                            onClick={() => {
                            ...
                            className="btn btn-sm bg-transparent text-orange-600 hover:bg-gray-300 hover:text-gray-900"
                        >
                            Clear All
                        </button>
                        <button onClick={() => setShowMenu(false)} className="btn btn-sm text-orange-600"><IoMdCloseCircleOutline size={20} /></button>
                    </div>
                ...
                <div className='lg:col-span-3 xl:col-span-4 p-2 rounded-md border border-gray-300'>
                    <div className='mb-4 flex flex-col md:flex-row justify-between md:items-center gap-4 '>
                        ...
                        <div className='flex gap-2 justify-between items-center'>
                            <select defaultValue="Pick a color" className="select select-sm max-w-40">
                            ...
                            <div>
                                <button onClick={() => setShowMenu(!showSideMenu)} className="btn btn-sm"><CiFilter size={20} /></button>
                            </div>
                        </div>
                    </div>
                    <div className="border-gray-300 mb-4 border-t"></div>
