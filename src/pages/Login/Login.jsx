  ...
  return (
    <div className="max-w-md mx-auto my-6 p-6 font-medium bg-white border border-gray-300 shadow-md rounded">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <button type="submit" className="w-full bg-[#f95c07] cursor-pointer text-white p-2 rounded">Login</button>
      </form>
      ...
      <p className="text-center mt-4 font-medium">
        Don't have any account? <Link state={{ from: from?.from, product }} className="text-[#f95c07]" to="/signup">Signup</Link>
      </p>
    </div>
  );
};
