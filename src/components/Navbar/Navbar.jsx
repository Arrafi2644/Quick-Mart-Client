...
const Navbar = () => {
  ...
  return (
    <div className='bg-orange-600 text-white font-medium h-auto'>
      {/* nav-1  */}
      <div className="navbar justify-between container mx-auto px-2">
        ...
        <div className="navbar-end grow">
          <ul className='menu menu-horizontal px-1 flex items-center'>
            <li><Link className='block md:hidden' onClick={()=>setShowSearchInput(!showSearchInput)} > <IoSearchOutline size={20} /></Link></li>
      ...
      {/* nav-2  */}
      <div className={`navbar shadow-sm ${showSearchInput? "block": "hidden"}`}>
