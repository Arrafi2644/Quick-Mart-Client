...
const Categories = () => {
    ...
    return (
        <div className='mt-6'>
            ...
            {/* section content */}
            <div className='grid grid-cols-6 md:grid-cols-8 lg:grid-cols-10'>
                {
                    categories.map(category => <Link  key={category._id} className='border p-6 w-full hover:shadow-xl border-gray-200 bg-white'>
